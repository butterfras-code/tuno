...
- Metronome: tail ±25° with sinusoidal motion, down on every audio beat and up halfway through; one full cycle spans one beat. Double-clicking or double-tapping Uno switches to a beat-by-beat left/right tail toggle mirrored across Uno's centerline. Phase follows scheduled beat timing, independent of bar numbering and subdivisions. Stop settles in 200 ms. Existing numeric tempo drag/wheel controls remain unchanged.
